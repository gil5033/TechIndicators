...
class TechnicalIndicatorMINUSDI(TechnicalIndicator):
    """
    Wrapper for the Minus Directional Indicator Rating from TA-lib
    References:
    ...
    def __init__(self, timeperiod=14):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorMINUSDI, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the Minus Directional Indicator technical indicator using a wrapper for the TA-lib
        ...
        output = DataFrame(MINUS_DI(high, low, close, self.__timeperiod))
        output.columns = ['MINUSDI%d' % self.__timeperiod]
        return output
