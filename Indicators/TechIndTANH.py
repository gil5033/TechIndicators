...
from talib import TANH
from pandas import DataFrame
__author__ = 'Pedro Henrique Veronezi e Sa'


class TechnicalIndicatorTANH(TechnicalIndicator):
    """
    Wrapper for the TANH - Vector Trigonometric from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorTANH, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the TANH - Vector Trigonometric using a wrapper for the TA-lib
