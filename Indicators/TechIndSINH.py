...
from talib import SINH
from pandas import DataFrame
__author__ = 'Pedro Henrique Veronezi e Sa'


class TechnicalIndicatorSINH(TechnicalIndicator):
    """
    Wrapper for the SINH - Vector Trigonometric from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorSINH, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the SINH - Vector Trigonometric using a wrapper for the TA-lib
