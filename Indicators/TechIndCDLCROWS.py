...
class TechnicalIndicatorCDLCROWS(TechnicalIndicator):
    """
    Wrapper for the Two Crows from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorCDLCROWS, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the Two Crows technical indicator using a wrapper for the TA-lib
        ...
        output = DataFrame(CDL2CROWS(open_price, high, low, close))
        output.columns = ['CDLCROWS']
        return output
