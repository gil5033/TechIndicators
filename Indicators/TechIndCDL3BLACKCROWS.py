...
class TechnicalIndicatorCDL3BLACKCROWS(TechnicalIndicator):
    """
    Wrapper for the Three Black Crows from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorCDL3BLACKCROWS, self).__init__()
    ...
    def _calc_indicator(self, OHLCV_input):
        ...
        output = DataFrame(CDL3BLACKCROWS(open_price, high, low, close))
        output.columns = ['CDL3BLACKCROWS']
        return output
