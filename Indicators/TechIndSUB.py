...
from talib import SUB
from pandas import DataFrame
__author__ = 'Pedro Henrique Veronezi e Sa'


class TechnicalIndicatorSUB(TechnicalIndicator):
    """
    Wrapper for the SUB - Vector Arithmetic from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorSUB, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the SUB - Vector Arithmetic using a wrapper for the TA-lib
