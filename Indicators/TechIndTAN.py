...
from talib import TAN
from pandas import DataFrame
__author__ = 'Pedro Henrique Veronezi e Sa'


class TechnicalIndicatorTAN(TechnicalIndicator):
    """
    Wrapper for the TAN - Vector Trigonometric from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorTAN, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the TAN - Vector Trigonometric using a wrapper for the TA-lib
