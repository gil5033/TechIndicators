...
class TechnicalIndicatorCDL3OUTSIDE(TechnicalIndicator):
    """
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorCDL3OUTSIDE, self).__init__()
    ...
    def _calc_indicator(self, OHLCV_input):
        ...
        output = DataFrame(CDL3OUTSIDE(open_price, high, low, close))
        output.columns = ['CDL3OUTSIDE']
        return output
