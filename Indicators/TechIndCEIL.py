...
from talib import CEIL
from pandas import DataFrame
__author__ = 'Pedro Henrique Veronezi e Sa'


class TechnicalIndicatorCEIL(TechnicalIndicator):
    """
    Wrapper for the CEIL - Vector Ceil from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorCEIL, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the CEIL - Vector Ceilusing a wrapper for the TA-lib
