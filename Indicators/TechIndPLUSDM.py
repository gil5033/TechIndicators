...
class TechnicalIndicatorPLUSDM(TechnicalIndicator):
    """
    Wrapper for the Plus Directional Momentum Rating from TA-lib
    References:
        https://github.com/mrjbq7/ta-lib
        http://www.tadoc.org/indicator/PLUS_DM.htm
    """
    ...
    def __init__(self, timeperiod=14):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorPLUSDM, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the Plus Directional Indicator technical Momentum using a wrapper for the TA-lib
        ...
        output = DataFrame(PLUS_DM(high, low, self.__timeperiod))
        output.columns = ['PLUSDM%d' % self.__timeperiod]
        return output
