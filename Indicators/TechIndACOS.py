...
from talib import ACOS
from pandas import DataFrame
__author__ = 'Pedro Henrique Veronezi e Sa'


class TechnicalIndicatorACOS(TechnicalIndicator):
    """
    Wrapper for the AACOS - Vector Trigonometric ACos from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorACOS, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the ACOS - Vector Trigonometric ACos using a wrapper for the TA-lib
