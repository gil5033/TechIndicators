...
from talib import MULT
from pandas import DataFrame
__author__ = 'Pedro Henrique Veronezi e Sa'


class TechnicalIndicatorMULTI(TechnicalIndicator):
    """
    Wrapper for the MULT - Vector Arithmetic from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorMULTI, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the MULT - Vector Arithmetic using a wrapper for the TA-lib
        ...
        output = DataFrame(MULT(high, low))
        output.columns = ['MULT']
        return output
