...
from talib import SQRT
from pandas import DataFrame
__author__ = 'Pedro Henrique Veronezi e Sa'


class TechnicalIndicatorSQRT(TechnicalIndicator):
    """
    Wrapper for the SQRT - Vector Trigonometric from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorSQRT, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the SQRT - Vector Trigonometric using a wrapper for the TA-lib
