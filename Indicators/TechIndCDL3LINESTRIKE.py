...
class TechnicalIndicatorCDL3LINESTRIKE(TechnicalIndicator):
    """
    Wrapper for the Three-Line Strike from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorCDL3LINESTRIKE, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the Three-Line Strike technical indicator using a wrapper for the TA-lib
        ...
        output = DataFrame(CDL3LINESTRIKE(open_price, high, low, close))
        output.columns = ['CDL3LINESTRIKE']
        return output
