...
class TechnicalIndicatorCDL3INSIDE(TechnicalIndicator):
    """
    Wrapper for the Three Inside Up/Down from TA-lib
    References:
    ...
    def __init__(self, timeperiod=0):
        ...
        Returns:
            self
        """
        super(TechnicalIndicatorCDL3INSIDE, self).__init__()
        self.__timeperiod = timeperiod

    def _calc_indicator(self, OHLCV_input):
        """
        Calculates the Three Inside Up/Down technical indicator using a wrapper for the TA-lib
        ...
        output = DataFrame(CDL3INSIDE(open_price, high, low, close))
        output.columns = ['CDL3INSIDE']
        return output
